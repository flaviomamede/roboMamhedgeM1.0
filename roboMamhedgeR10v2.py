...
def run_backtest_trades(
    ...
    for i in range(start_i, len(df)):
        ...
        long_signal = ema_up and rsi_bull and macd_ok_long and vwap_ok_long
        short_signal = ema_down and rsi_bear and macd_ok_short and vwap_ok_short
...
if __name__ == "__main__":
    ...
    if len(trades) == 0:
        ...
        print(
            f"[R10 v2] Trades: {len(tr)} ({DEFAULT_QUANTITY} contratos) | "
